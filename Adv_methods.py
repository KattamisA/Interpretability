...
for image in image_dataset:
    ...
    for epsilon in epsilon_values:
        adv, orig, pert = adversarial_examples("data/{}".format(image), method="FGSM", eps=epsilon, show=False, model_name='inception_v3')
...
for image in image_dataset:
    ...
    for epsilon in epsilon_values:
        adv, orig, pert = adversarial_examples("data/{}".format(image), method="BI", eps=epsilon, show=False, model_name='inception_v3')
...
for image in image_dataset:
    ...
    for epsilon in epsilon_values:
        adv, orig, pert = adversarial_examples("data/{}".format(image), method="LLCI", eps=epsilon, show=False, model_name='inception_v3')
