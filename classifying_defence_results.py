...
for i in range(0, 15, 3):
    ...
    for j in range(250,1001,250):
        image = cv2.imread("results/Defence/Clean/Image_{}_{}it.png".format(i, j))[..., ::-1]
        _, ranks_rec = classification(image, sort=True, show=False, model_name='resnet18', cuda=False)
