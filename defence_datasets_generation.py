...
for i in range(0, len(classids), 3):
    ...
    output = dip(adv, 'complex', 0.01, 1001, plot=False, save=True, save_path = 'results/Defence/FGSM2', name = "Image_{}".format(i))
    _, ranks_rec = classification(output*255.0, sort=True, show=False, model_name='resnet18', cuda=True)
    if ranks_rec[0,0] == int(classids[i]):
...
for i in range(0, len(classids), 3):
    ...
    output = dip(adv, 'complex', 0.01, 1001, plot=False, save=True, save_path = 'results/Defence/FGSM5', name = "Image_{}".format(i))
    _, ranks_rec = classification(output*255.0, sort=True, show=False, model_name='resnet18', cuda=True)
    if ranks_rec[0,0] == int(classids[i]):
        defence_rec = defence_rec + 1
    print("Results after {:>3}: Defence: {:>7.3f}".format(num, float(defence_rec)/num), end='\r')
...
for i in range(0, len(classids), 3):
    ...
    output = dip(adv, 'complex', 0.01, 1001, plot=False, save=True, save_path = 'results/Defence/FGSM10', name = "Image_{}".format(i))
    _, ranks_rec = classification(output*255.0, sort=True, show=False, model_name='resnet18', cuda=True)
    if ranks_rec[0,0] == int(classids[i]):
        defence_rec = defence_rec + 1
    print("Results after {:>3}: Defence: {:>7.3f}".format(num, float(defence_rec)/num), end='\r')
...
for i in range(0, len(classids), 3):
    ...
    output = dip(adv, 'complex', 0.01, 1001, plot=False, save=True, save_path = 'results/Defence/BI10', name = "Image_{}".format(i))
    _, ranks_rec = classification(output*255.0, sort=True, show=False, model_name='resnet18', cuda=True)
    if ranks_rec[0,0] == int(classids[i]):
        defence_rec = defence_rec + 1
    print("Results after {:>3}: Defence: {:>7.3f}".format(num, float(defence_rec)/num), end='\r')
...
for i in range(0, len(classids), 3):
    ...
    output = dip(adv, 'complex', 0.01, 1001, plot=False, save=True, save_path = 'results/Defence/LLCI10', name = "Image_{}".format(i))
    _, ranks_rec = classification(output*255.0, sort=True, show=False, model_name='resnet18', cuda=True)
    if ranks_rec[0,0] == int(classids[i]):
        defence_rec = defence_rec + 1
    print("Results after {:>3}: Defence: {:>7.3f}".format(num, float(defence_rec)/num), end='\r')
