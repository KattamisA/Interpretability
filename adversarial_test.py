...
adv, _, pert = adversarial_examples("data/{}".format(image_path), method="JSMA", eps=1, show=True)
print(pert)

adv, _, pert = adversarial_examples("data/{}".format(image_path), method="JSMA", eps=100, show=True)
# print(pert)
